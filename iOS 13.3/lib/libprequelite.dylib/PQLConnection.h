...
- (bool)_execute:(id)arg1 mustSucceed:(bool)arg2 bindings:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg3;
...
- (id)_newStatementForFormat:(id)arg1 arguments:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg2;
...
- (bool)execute:(id)arg1 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg2;
- (bool)executeRaw:(id)arg1;
- (id)fetch:(id)arg1;
- (id)fetch:(id)arg1 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg2;
- (id)fetchObject:(id /* block */)arg1 sql:(id)arg2;
- (id)fetchObject:(id /* block */)arg1 sql:(id)arg2 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg3;
- (id)fetchObjectOfClass:(Class)arg1 initializer:(SEL)arg2 sql:(id)arg3;
- (id)fetchObjectOfClass:(Class)arg1 initializer:(SEL)arg2 sql:(id)arg3 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg4;
- (id)fetchObjectOfClass:(Class)arg1 sql:(id)arg2;
- (id)fetchObjectOfClass:(Class)arg1 sql:(id)arg2 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg3;
- (void)flush;
...
// Image: /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Library/Developer/CoreSimulator/Profiles/Runtimes/iOS.simruntime/Contents/Resources/RuntimeRoot/System/Library/PrivateFrameworks/CloudDocsDaemon.framework/CloudDocsDaemon

// PQLConnection (BRCAdditions)
