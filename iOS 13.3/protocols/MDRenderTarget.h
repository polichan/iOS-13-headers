...
- (void)renderWithTimestamp:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 5: double, struct function<void ()>={__value_func<void ()>={type=[32C] {}, struct __base<void ()> {}*, /* Warning: Unrecognized filer type: '}' using 'void*' */ void*, void*
