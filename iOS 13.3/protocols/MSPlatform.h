...
- (void)logFacility:(int)arg1 level:(int)arg2 format:(NSString *)arg3 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg4;
- (void)logFile:(const char *)arg1 func:(const char *)arg2 line:(int)arg3 facility:(int)arg4 level:(int)arg5 format:(NSString *)arg6 args:(struct __va_list_tag { unsigned int x1; unsigned int x2; void *x3; void *x4; })arg7;
